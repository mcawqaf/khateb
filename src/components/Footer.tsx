        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="rounded-md overflow-hidden inline-flex shrink-0 border-2 border-[#DFB76C] ring-2 ring-[#DFB76C]/30 shadow-lg">
                <img 
      ...
      <div className="bg-[#030B14] border-t border-white/10 py-4 text-center text-xs text-slate-400">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <div className="text-[11px] text-slate-500 font-mono">
            جميع الحقوق محفوظة © مكتب الإعلام 1448هـ - 2026م
          </div>
        </div>
      </div>
    </footer>
