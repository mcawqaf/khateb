...
export const TermsAndConditions: React.FC<TermsAndConditionsProps> = ({ onProceedToRegister }) => {
  ...
  const termsList = [
    ...
    {
      id: 3,
      title: 'ألا يقل العمر عن 18 سنة ولا يزيد على 30 سنة',
      explanation: 'يشترط بلوغ السن القانونية والتكليفية لضمان النضج العلمي والدعوي، وألا يتجاوز المتقدم الثلاثين عاماً وقت التسجيل.',
      icon: Calendar,
      badge: 'الفئة العمرية',
      highlight: true
    },
    ...
    {
      id: 7,
      title: 'الالتزام الكامل بحضور جميع الدروس والفعاليات',
      explanation: 'المواظبة التامة على جميع الدروس والورش والفعاليات المقررة طوال مدة البرنامج دون انقطاع.',
      icon: CheckCircle,
    ...
    {
      id: 8,
      title: 'الالتزام بالمبيت في السكن لمن سُجِّل ضمن المقيمين',
      explanation: 'السكن الداخلي مكفول لجميع المقبولين بدون استثناء، ومن سجّل نفسه ضمن المقيمين يلتزم بالمبيت طوال أيام البرنامج والمحافظة على مرافق السكن.',
      icon: BedDouble,
      badge: 'نظام الإقامة',
      highlight: true
    },
    {
      id: 9,
      title: 'تعبئة الاستبيان الإلكتروني وتقديم نسخة ورقية',
      explanation: 'إتمام التسجيل خلال فترة القبول التي يُعلن عنها قريباً، وطباعة بطاقة المراجعة المحتوية على الرقم المتسلسل وإحضارها عند الحضور للمقابلة الشخصية.',
      icon: FileText,
      badge: 'إجراء إداري',
      highlight: true
    },
    {
      id: 10,
      title: 'اجتياز المقابلة الشخصية',
      explanation: 'الحضور للمقابلة الشخصية أمام اللجنة المشرفة على البرنامج واجتيازها، والالتزام بما تقرره اللجنة في شأن القبول.',
      icon: ShieldCheck,
      badge: 'قرار اللجنة',
      highlight: true
    }
