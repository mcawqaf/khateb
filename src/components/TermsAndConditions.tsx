...
export const TermsAndConditions: React.FC<TermsAndConditionsProps> = ({ onProceedToRegister }) => {
  ...
  const termsList = [
    ...
    },
    {
      ...
      explanation: 'المواظبة التامة على البرنامج التدريبي والورش التطبيقية، والانضباط الكامل بنظام الإقامة الداخلية. والسكن مكفول لجميع الطلبة المقبولين بدون استثناء.',
      icon: BedDouble,
