...
export const TermsAndConditions: React.FC<TermsAndConditionsProps> = ({ onProceedToRegister }) => {
  ...
  const termsList = [
    {
      id: 1,
      title: 'ألا يكون المتقدم خطيباً',
      explanation: 'البرنامج مخصص لإعداد وتأهيل الكوادر الجديدة التي لم تمارس الخطابة المنبرية الرسمية.',
      icon: ShieldAlert,
      badge: 'شرط أساسي',
      highlight: true
    },
    {
      id: 2,
      title: 'ألا يكون قد سبق له المشاركة في إحدى الدورات السابقة',
    ...
    {
      id: 3,
      title: 'ألا يقل عمره عن 18 سنة ولا يزيد على 30 سنة',
      explanation: 'يُحتسب العمر من تاريخ الميلاد المُدخل في الاستمارة، ويُرفض الطلب آلياً خارج هذا النطاق.',
      icon: Calendar,
      badge: 'الفئة العمرية',
      highlight: true
    },
    {
      id: 4,
      title: 'أن يكون سليم النطق، حسن الأداء، فصيحاً',
    ...
    {
      id: 5,
      title: 'أن يكون حسن السيرة والسلوك والمظهر',
      explanation: 'الاستقامة والالتزام بالأخلاق والسمت الإسلامي القويم، والعناية بالهيئة والمظهر بما يتوافق مع الأحكام والآداب الشرعية.',
      icon: Compass,
      badge: 'السمت والقدوة',
      highlight: false
    },
    {
      id: 6,
      title: 'الالتزام بحضور جميع الدروس والفعاليات والمبيت للمقيمين',
      explanation: 'المواظبة التامة على جميع الدروس والفعاليات المقررة طوال مدة البرنامج، والمبيت في السكن لمن تم تسجيله ضمن المقيمين.',
      icon: BedDouble,
    ...
    {
      id: 7,
      title: 'تعبئة الاستبيان الإلكتروني وتقديم نسخة ورقية عند المقابلة',
      explanation: 'إتمام التسجيل خلال الفترة المحددة، وطباعة بطاقة المراجعة المحتوية على الرقم المتسلسل وإحضارها عند الحضور للمقابلة الشخصية.',
      icon: FileText,
      badge: 'إجراء إداري',
      highlight: true
    },
    {
      id: 8,
      title: 'اجتياز المقابلة الشخصية والالتزام بما تقرره اللجنة المشرفة',
      explanation: 'الحضور للمقابلة الشخصية في موعدها واجتيازها، والالتزام بما تقرره اللجنة المشرفة على البرنامج في شأن القبول.',
      icon: ShieldCheck,
      badge: 'قرار اللجنة',
      highlight: true
    }
